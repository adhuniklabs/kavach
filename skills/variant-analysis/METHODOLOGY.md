...
Maintain a tracking document (see `resources/variant-report-template.md` - this lives in
`.kavach/tmp/variant-workspace/<original-finding-slug>/`, not `.kavach/findings/`):
