---
name: kavach-llm
description: KAVACH LLM/AI security specialist. Audits prompt injection (direct + indirect/RAG), jailbreak/persona/system-prompt leak, excessive agency, insecure output handling, the bias scenario matrix, and model DoS/cost-abuse. Dispatch as part of the `hunt` static-analysis fan-out.
